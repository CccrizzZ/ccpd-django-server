...
class InstockInventory(models.Model):
    ...
    qaTime = models.CharField(max_length=80)
    shelfLocation = models.CharField(max_length=4)
    ...
    def __init__(self, sku, time, qaTime, shelfLocation, condition, comment, lead, description, url, marketplace, platform, adminName, qaName, quantityInstock, quantitySold, msrp) -> None:
        self.sku = sku
        self.time = time
        self.qaTime = qaTime
        self.shelfLocation = shelfLocation
